...
class VelocityController(Node):
    def __init__(self):
        ...
        # Confirm node is up and display keybinds
        self.get_logger().info("🎮 Velocity Controller online.")
    ...
    def process_key(self, key):
        ...
        if key == 'w':
            ...
            # Gradual stop — halve all velocities until near zero
            self.linear_x *= 0.5
            self.linear_y *= 0.5
            self.angular_z *= 0.5
            ...
            # Emergency stop — zero out all velocities immediately
            self.linear_x = 0.0
            self.linear_y = 0.0
            self.angular_z = 0.0
            print("\n🛑 EMERGENCY STOP!")
    ...
    def print_status(self):
        ...
        # Inline status readout — overwrites current line on each keypress
    ...
    def stop_robot(self):
        ...
        self.cmd_vel_pub.publish(cmd)
        self.running = False
        # Confirm robot has been commanded to halt
        print("\n🛑 Halt command sent.")
